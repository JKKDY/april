...
namespace april::cont {
	...
	namespace impl {
		...
		public:
			...
			void build(const std::vector<env::Particle>& particles);
		...
		template <class Env>
		LinkedCells<Env>::LinkedCells(const cont::LinkedCells& config):
			Container<cont::LinkedCells, Env>(config),
			outside_cell(Cell::ParticleSet(0), {max_uint, max_uint, max_uint}, 0)
		{}

		template <class Env>
		void LinkedCells<Env>::build(const std::vector<env::Particle>& particles) {
		...
		template <class Env>
		void LinkedCells<Env>::calculate_forces() {
		...
		template <class Env>
		void LinkedCells<Env>::build_cells() {
		...
		template <class Env>
		void LinkedCells<Env>::build_cell_pairs() {
		...
		template <class Env>
		typename LinkedCells<Env>::Cell& LinkedCells<Env>::get_cell(const vec3& position) noexcept {
		...
		template <class Env>
		typename LinkedCells<Env>::Cell& LinkedCells<Env>::get_cell(const uint3& idx) {
