...
using ParticleRecord = particle::ParticleRecord<core::NoParticleAttributes>;
...
struct TouchSpy final : Boundary {
	...
	void apply(particle::internal::ScalarParticleRef<M, U> & p, const core::Box &, Face) const noexcept {
